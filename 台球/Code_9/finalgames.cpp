...
void loadpicture()         //图片加载
{
	...
	loadimage(&img_start,_T("E:\\1\\c laugage class\\fanal games\\台球游戏素材\\开始菜单.jpg"));
	...
	loadimage(&point1,_T("E:\\1\\c laugage class\\fanal games\\台球游戏素材\\箭头.jpg"));
	loadimage(&point_1,_T("E:\\1\\c laugage class\\fanal games\\台球游戏素材\\箭头遮罩.jpg"));
...
/*void startMenu()//初始菜单界面
{
	...
	outtextxy(Width*0.4,High*0.3,"1 新游戏");
	outtextxy(Width*0.4,High*0.4,"2 退出");

	settextcolor(BLUE);
	settextstyle(20,0,_T("宋体"));
	outtextxy(Width*0.35,High*0.6,"鼠标移动控制球杆旋转");
	outtextxy(Width*0.35,High*0.65,"点击鼠标左键确定方向，点击空格出杆");
